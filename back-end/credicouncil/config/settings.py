"""
CREDICOUNCIL Settings — Environment-based configuration.
...
class Settings(BaseSettings):
    ...
    # ── Amazon Textract ──
    textract_bucket: str = "credicouncil-documents"

    # ── SageMaker ──
    sagemaker_endpoint_name: str = "credicouncil-lgbm-endpoint"

    # ── DynamoDB ──
    dynamodb_table_state: str = "credicouncil-state"
    dynamodb_table_audit: str = "credicouncil-audit"
    ...
    # ── S3 ──
    s3_bucket_documents: str = "credicouncil-documents"
    s3_bucket_models: str = "credicouncil-models"
