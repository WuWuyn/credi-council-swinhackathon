"""
CREDICOUNCIL A3 — ML Scoring Agent (Local Version).
...
from credicouncil.agents.a3_scoring.score_mapper import map_prediction
...
class ScoringAgent:
    ...
    def _compute_shap(
        ...
        try:
            import shap
            from credicouncil.config.feature_config import get_label_vi, get_5c_dimension
