"""
CREDICOUNCIL A4 — Report Generator Agent (Local Version).
...
from credicouncil.agents.a4_report_generator.five_c_scorer import (
    compute_five_c_scores, five_c_to_dict, DimensionScore,
)
from credicouncil.agents.a4_report_generator.decision_engine import (
    compute_decision, CreditDecision,
)
from credicouncil.config.feature_config import get_label_vi
