"""
CREDICOUNCIL Orchestrator — LangGraph StateGraph Definition.
...
def build_graph(
    ...
    """Build the CREDICOUNCIL LangGraph StateGraph.
    ...
    """
    logger.info("Building CREDICOUNCIL LangGraph StateGraph (9 nodes)...")
    ...
    def consistency_validator_node(state: CreditState) -> dict[str, Any]:
        ...
        """
        from credicouncil.agents.a4_report_generator.consistency_validator import (
...
def run_pipeline(
    ...
    """Run the full CREDICOUNCIL pipeline.
    ...
    logger.info(f"Running CREDICOUNCIL pipeline for {applicant_id}")
